...
import { ValidationError } from '../lib/validate-definition';
...
export type V2StepConditionThreshold = z.infer<typeof V2StepConditionThresholdSchema>;
...
export interface TriggerStartLabelStep {
  id: 'trigger_start';
  name: 'Triggers';
  type: 'trigger';
...
export interface TriggerEndLabelStep {
  id: 'trigger_end';
  name: 'Steps';
  type: '';
  componentType: 'trigger';
...
interface ConditionAssertEndNodeData {
  id: string;
...
interface ConditionThresholdEndNodeData {
  id: string;
